...
func refuel(myPlane : Aviatrix) {
    ...
    print("Refueling...")
    print("⛽ Here in \(plane.location), jet fuel costs \(plane.data.fuelPrices[plane.location]!)")

    print("⛽ You refueled \(plane.numGallon) gallons totaling \(plane.data.fuelPrices[plane.location]!*plane.numGallon)")
}
...
var plane = Aviatrix(authorName:"Olivia")
